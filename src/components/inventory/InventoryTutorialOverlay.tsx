...
import type { InventoryTutorialStep } from "../../hooks/useInventoryTutorial";

type InventoryTutorialOverlayProps = {
  isOpen: boolean;
  steps: InventoryTutorialStep[];
  currentIndex: number;
  onNext: () => void;
  onPrev: () => void;
  onClose: () => void;
...
export function InventoryTutorialOverlay({
  isOpen,
  steps,
  currentIndex,
  onNext,
