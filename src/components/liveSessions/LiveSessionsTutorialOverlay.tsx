...
import type { LiveSessionsTutorialStep } from "../../hooks/useLiveSessionsTutorial";

type LiveSessionsTutorialOverlayProps = {
  isOpen: boolean;
  steps: LiveSessionsTutorialStep[];
  currentIndex: number;
  onNext: () => void;
  onPrev: () => void;
  onClose: () => void;
...
export function LiveSessionsTutorialOverlay({
  isOpen,
  steps,
  currentIndex,
  onNext,
  ...
  onClose,
  onSkip,
}: LiveSessionsTutorialOverlayProps) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Live sessions tutorial"
      >
