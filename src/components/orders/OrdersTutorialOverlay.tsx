...
import type { OrdersTutorialStep } from "../../hooks/useOrdersTutorial";

type OrdersTutorialOverlayProps = {
  isOpen: boolean;
  steps: OrdersTutorialStep[];
  currentIndex: number;
  onNext: () => void;
  onPrev: () => void;
  onClose: () => void;
...
export function OrdersTutorialOverlay({
  isOpen,
  steps,
  currentIndex,
  onNext,
