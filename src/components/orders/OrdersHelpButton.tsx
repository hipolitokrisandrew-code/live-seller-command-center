...
type OrdersHelpButtonProps = ButtonHTMLAttributes<HTMLButtonElement>;

export function OrdersHelpButton({
  className,
  ...props
}: OrdersHelpButtonProps) {
  return (
    <div className="fixed bottom-4 right-4 z-40 md:bottom-6 md:right-6">
      ...
      >
        ...
        <span className="sr-only">Orders help</span>
