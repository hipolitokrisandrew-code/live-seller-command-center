...
import type { ClaimsTutorialStep } from "../../hooks/useClaimsTutorial";

type ClaimsTutorialOverlayProps = {
  isOpen: boolean;
  steps: ClaimsTutorialStep[];
  currentIndex: number;
  onNext: () => void;
  onPrev: () => void;
  onClose: () => void;
...
export function ClaimsTutorialOverlay({
  isOpen,
  steps,
  currentIndex,
  onNext,
