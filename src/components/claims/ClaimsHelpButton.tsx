...
type ClaimsHelpButtonProps = ButtonHTMLAttributes<HTMLButtonElement>;

export function ClaimsHelpButton({
  className,
  ...props
}: ClaimsHelpButtonProps) {
  return (
    <div className="fixed bottom-4 right-4 z-40 md:bottom-6 md:right-6">
      ...
      >
        ...
        <span className="sr-only">Claims help</span>
