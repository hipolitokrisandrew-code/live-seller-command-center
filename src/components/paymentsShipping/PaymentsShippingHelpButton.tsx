...
type PaymentsShippingHelpButtonProps = ButtonHTMLAttributes<HTMLButtonElement>;

export function PaymentsShippingHelpButton({
  className,
  ...props
}: PaymentsShippingHelpButtonProps) {
  return (
    <div className="fixed bottom-4 right-4 z-40 md:bottom-6 md:right-6">
      <button
        ...
        className={[
          ...
          .filter(Boolean)
          .join(" ")}
        aria-label="Payments and shipping help"
        {...props}
      >
        <svg
          aria-hidden="true"
        ...
        <span className="sr-only">Payments and shipping help</span>
