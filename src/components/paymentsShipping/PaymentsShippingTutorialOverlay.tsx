...
import type { PaymentsShippingTutorialStep } from "../../hooks/usePaymentsShippingTutorial";

type PaymentsShippingTutorialOverlayProps = {
  isOpen: boolean;
  steps: PaymentsShippingTutorialStep[];
  currentIndex: number;
  onNext: () => void;
  onPrev: () => void;
  onClose: () => void;
...
export function PaymentsShippingTutorialOverlay({
  isOpen,
  steps,
  currentIndex,
  onNext,
  ...
  onClose,
  onSkip,
}: PaymentsShippingTutorialOverlayProps) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Payments and shipping tutorial"
      >
