...
type FinanceHelpButtonProps = ButtonHTMLAttributes<HTMLButtonElement>;

export function FinanceHelpButton({
  className,
  ...props
}: FinanceHelpButtonProps) {
  return (
    <div className="fixed bottom-4 right-4 z-40 md:bottom-6 md:right-6">
      ...
      >
        ...
        <span className="sr-only">Finance help</span>
