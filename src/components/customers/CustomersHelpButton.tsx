...
type CustomersHelpButtonProps = ButtonHTMLAttributes<HTMLButtonElement>;

export function CustomersHelpButton({
  className,
  ...props
}: CustomersHelpButtonProps) {
  return (
    <div className="fixed bottom-4 right-4 z-40 md:bottom-6 md:right-6">
      ...
      >
        ...
        <span className="sr-only">Customers help</span>
