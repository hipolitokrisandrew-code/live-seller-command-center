...
import type { CustomersTutorialStep } from "../../hooks/useCustomersTutorial";

type CustomersTutorialOverlayProps = {
  isOpen: boolean;
  steps: CustomersTutorialStep[];
  currentIndex: number;
  onNext: () => void;
  onPrev: () => void;
  onClose: () => void;
...
export function CustomersTutorialOverlay({
  isOpen,
  steps,
  currentIndex,
  onNext,
