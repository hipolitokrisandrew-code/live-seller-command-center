    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      <div className="flex min-h-screen">
        ...
        <div className="flex min-w-0 flex-1 flex-col relative z-0">
          <header className="z-50 flex items-center justify-between gap-4 border-b border-slate-200 bg-white px-4 py-3 shadow-sm shadow-slate-900/5 backdrop-blur md:px-6 lg:sticky lg:top-0">
            <div className="flex items-center gap-3">
              <button
                type="button"
